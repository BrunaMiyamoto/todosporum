            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg py-10 px-20">
                <form action="#" method="post">
                    ...
                    <div class="pt-6 grid">
                        ...
                        <input class="" type="file" name="fotoperfil" id="fotoperfil"
                    ...
                    @foreach ($perfil as $per)
                        <div class="pt-5 grid">
                            ...
                            <input class="bg-[#ebf2fa] border-none rounded-2xl text-[#333333] " type="text"
                                name="nome" id="nome" placeholder="{{ $per->nome }}" />
                        </div>
