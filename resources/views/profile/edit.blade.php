...
@section('conteudo')
    {{-- <x-slot name="header">
            <h2 class="font-semibold text-2xl text-[#ebf2fa] leading-tight">
                {{ __('Segurança') }}
            </h2>
        </x-slot> --}}
    ...
    <div class=" bg-[#ebf2fa] py-12 max-w-4xl text-sm grid grid-cols-1 px-8 sm:grid-cols-[auto_1fr] mx-auto gap-9">
        ...
        <div class="">
            <div class="">
                <div
                    class="bg-white mb-6 overflow-hidden shadow-[0px_0px_6px_rgba(0,0,0,0.5)] pb-6 rounded-lg sm:rounded-lg px-14 mx-auto h-full">
                    <div class="max-w-xl">
